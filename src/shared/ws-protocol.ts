...
export const projectCreateSchema = z.object({
  ...
  defaultBranch: z.enum(['HEAD', 'main', 'dev']).nullable().optional(),
  ...
  defaultSummarizeThreshold: z.number().optional(),
