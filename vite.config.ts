...
export default defineConfig(({ isSsrBuild }) => ({
  ...
  server: {
    ...
    watch: {
      ...
      ignored: ['**/.worktrees/**', '**/.claude/worktrees/**', '**/data/**', '**/.react-router/**', '**/src/orcd/**'],
    },
  },
  plugins: [swVersionPlugin(), wsServerPlugin(), pwaLogPlugin(), tailwindcss(), reactRouter(), tsconfigPaths()],
}));
